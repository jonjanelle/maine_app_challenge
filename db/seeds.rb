...
Category.create(name: "Xamarin", 
                description: "Learn about creating apps in C# with Xamarin")
...
ResourceCategory.create(resource_id: Resource.last.id,
                        category_id: Category.where(name: "Android").first.id)
ResourceCategory.create(resource_id: Resource.last.id,
                        category_id: Category.where(name: "MIT App Inventor").first.id)
...
ResourceCategory.create(resource_id: Resource.last.id,
                        category_id: Category.where(name: "Android").first.id)
ResourceCategory.create(resource_id: Resource.last.id,
                        category_id: Category.where(name: "Xamarin").first.id)
